      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="space-y-8 text-sm text-zinc-300 leading-relaxed">
          ...
          <section>
            ...
            <ul className="list-disc pl-5 space-y-2">
              <li><strong className="text-white">LLM provider:</strong> Your incident symptoms and signals are sent to the configured language-model provider for analysis. This deployment routes requests through an OpenAI-compatible API gateway, which forwards them to an upstream model provider on our behalf — so your incident text is processed by both the gateway operator and that upstream provider. Groq and OpenAI are used directly as fallbacks when the gateway is unavailable (see <a href="https://groq.com/privacy-policy/" target="_blank" rel="noopener noreferrer" className="text-indigo-400 hover:underline">Groq&apos;s Privacy Policy</a> and <a href="https://openai.com/privacy" target="_blank" rel="noopener noreferrer" className="text-indigo-400 hover:underline">OpenAI&apos;s Privacy Policy</a>).</li>
